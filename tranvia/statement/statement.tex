...
\begin{inputDescription}
  ...
  %
  %
  La segunda línea contiene $N$ enteros ordenados entre 0 y $L$ correspondientes
  a la distancia donde se ubica cada una de las estaciones.
  %
  ...
  %
  En caso contrario, $p$ indica la posición del tren desde el inicio
  de la línea.
